  ...
  <footer id="footer" class="footer" data-bg-img="images/footer-bg.png" data-bg-color="#25272e">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list-inline mt-5">
                <li class="m-0 pl-10 pr-10"><i class="fa fa-map text-theme-colored mr-5"></i><a class="text-grey">4, Tayo Olukoya Close, Ojodu Estate, Ojodu-Berger, Ikeja, Lagos.</a></li>
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-theme-colored mr-5"></i> <a class="text-gray" href="tel: +234-9049772605">+234-9049772605, +234-8052189288, +234-9049772605</a> </li>
    ...
    <div class="footer-bottom bg-black-333">
      <div class="container pt-15 pb-10">
        <div class="row">
          <div class="col-md-6">
            <p class="font-11 text-black-777 m-0 sm-text-center">Copyright &copy;{{ date('Y') }} New Analysis Associates Psychological Service (NAAPS). All Rights Reserved</p>
          </div>
        </div>
      </div>
    </div>
