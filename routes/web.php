...
Route::get('/consultation', 'PagesController@models_consultation');

Route::get('/intervention', 'PagesController@models_intervention');

Route::get('assessment', 'PagesController@models_assessment');
